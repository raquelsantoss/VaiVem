  ...
  return (
    <div className="mt-5">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-semibold">Avaliaçoes</h1>
      ...
      {reviews.length === 0 && (
        <div className="text-gray-500">
          <span>Ainda não há comentários. Seja o primeiro a avaliar este produto.</span>
        </div>
      )}
      ...
      <Modal
        ...
        title={
          <div className="flex justify-between items-center uppercase">
            <h1 className="text-2xl font-semibold">Avaliar</h1>
          </div>
        }
        closable={false}
