      ...
      {cartItems.length > 0 ? (
        <div className="grid grid-cols-1 xl:grid-cols-3 text-gray-700 gap-10">
          <div className="col-span-2 flex flex-col gap-5">
            <span className="text-2xl font-semibold">Meu Carrinho</span>
            <div className="hidden md:grid grid-cols-7 gap-10">
              <span className="col-span-4">Produto</span>
              <span className="col-span-1">Cada</span>
            ...
            {cartItems.map((item) => (
              ...
              >
                ...
                <span className="col-span-1">R$ {item.price}</span>
          ...
          <div className="col-span-1 border border-gray-400 border-solid p-5">
            <h1 className="text-xl font-semibold">Total a pagar</h1>
        ...
        <div className="flex flex-col items-center gap-5 text-gray-700">
          ...
          <h1 className="text-sm">Seu carrinho está vazio</h1>
        </div>
      )}
